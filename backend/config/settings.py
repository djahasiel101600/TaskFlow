...
# Allow proxied requests from the frontend (dev server or Docker nginx).
_frontend_origins = ["http://localhost:5173", "http://127.0.0.1:5173"]
if os.environ.get("FRONTEND_ORIGIN"):
    _frontend_origins.append(os.environ["FRONTEND_ORIGIN"].rstrip("/"))
CSRF_TRUSTED_ORIGINS = _frontend_origins.copy()
...
DATABASES = {
    "default": {
        ...
        "OPTIONS": {} if os.environ.get("DB_SSLMODE") == "disable" else {"sslmode": "require"},
    }
}
...
CORS_ALLOWED_ORIGINS = _frontend_origins.copy()
